# -*- coding: utf-8 -*-
"""
Created on Thu Apr 15 17:17:22 2024
...
from metric.utils import get_bboxes, mean_average_precision
...
PIN_MEMORY = True
LOAD_MODEL = False
LOAD_MODEL_FILE = "hw_1_model.pth"
...
def save_checkpoint(state, filename="default_checkp.pth"):
    print("...Saving...")
...
if __name__ == "__main__":
    ...
    train_dataset = Coco(
        transform=transform,
        files_dir="./dataset/train2017",
        ann_path="./dataset/annotations/instances_train2017.json",
    )

    test_dataset = Coco(
        transform=transform,
        files_dir="./dataset/val2017",
        ann_path="./dataset/annotations/instances_val2017.json",
    )
